...
int main(int argc, char **argv)
{
    ...
    int test_sizes[] =
        ...
        /* // Multiples-of-32, +/- 1. Large  only
        {511,512,513,543,544,545,575,576,577,607,608,609,639,640,641,671,672,673,703,704,705,735,736,
        737,767,768,769,799,800,801,831,832,833,863,864,865,895,896,897,927,928,929,959,960,961,
        991,992,993,1023,1024,1025, 2047, 2048};  */

        // Multiples-of-128, +/- 1. Large  only
        {511,512,513, 639,640,641, 767,768,769, 895,896,897, 1023,1024,1025, 
        ...
        { 31, 32, 33, 39, 40, 41, 47, 48, 49, 55, 56, 57, 63, 64, 65, 71, 72, 73, 
        79, 80, 81, 87, 88, 89, 95, 96, 97, 103, 104, 105, 111, 112, 113, 119, 120, 121, 
        127, 128, 129, 135, 136, 137, 143, 144, 145, 151, 152, 153, 159, 160, 161, 
        167, 168, 169, 175, 176, 177, 183, 184, 185, 191, 192, 193, 199, 200, 201, 
        207, 208, 209, 215, 216, 217, 223, 224, 225, 231, 232, 233, 239, 240, 241, 
        247, 248, 249, 255, 256, 257, 263, 264, 265, 271, 272, 273, 279, 280, 281, 
        287, 288, 289, 295, 296, 297, 303, 304, 305, 311, 312, 313, 319, 320, 321, 
        327, 328, 329, 335, 336, 337, 343, 344, 345, 351, 352, 353, 359, 360, 361, 
        367, 368, 369, 375, 376, 377, 383, 384, 385, 391, 392, 393, 399, 400, 401, 
        407, 408, 409, 415, 416, 417, 423, 424, 425, 431, 432, 433, 439, 440, 441, 
        447, 448, 449, 455, 456, 457, 463, 464, 465, 471, 472, 473, 479, 480, 481, 
        487, 488, 489, 495, 496, 497, 503, 504, 505, 511, 512, 513, 519, 520, 521, 
        527, 528, 529, 535, 536, 537, 543, 544, 545, 551, 552, 553, 559, 560, 561, 
        567, 568, 569, 575, 576, 577, 583, 584, 585, 591, 592, 593, 599, 600, 601, 
        607, 608, 609, 615, 616, 617, 623, 624, 625, 631, 632, 633, 639, 640, 641, 
        647, 648, 649, 655, 656, 657, 663, 664, 665, 671, 672, 673, 679, 680, 681, 
        687, 688, 689, 695, 696, 697, 703, 704, 705, 711, 712, 713, 719, 720, 721, 
        727, 728, 729, 735, 736, 737, 743, 744, 745, 751, 752, 753, 759, 760, 761, 767, 768, 769 }; */
